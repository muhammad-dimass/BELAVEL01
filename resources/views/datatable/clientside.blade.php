          ...
          <div class="card">
              ...
              <div class="row">
                <div class="col-lg-5 col-5">
                  ...
                  <p class="text-sm mb-0">
                    ...
                    <span class="font-weight-bold ms-1"> users</span>( client side )
                  </p>
                </div>
            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive">
                <table class="table align-items-center mb-0" id="clientside">
                  <thead>
                    <tr>
                  ...
                  <tbody>
                    @foreach($data as $d)
                      ...
                      <td>
                        <div class="avatar-group mt-2">
                          <img width="100px" alt="{{ $d->name }}" src="{{ asset('storage/photo.user/'.$d->image) }}">
                        </div>
                      </td>
                      <td>
                        <div class="avatar-group mt-2">
                         <a href="{{ route('edituser',['id' => $d->id]) }}"><i class="fa fa-edit me-sm-1"></i></a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
      	<form method="POST" action="{{ route('deleteuser',['id'=>$d->id]) }}">
      		@csrf
      		@method('DELETE')
